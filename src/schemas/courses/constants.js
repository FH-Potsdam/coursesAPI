export const SUPPORTED_STUDIES = {
	design: 'Design (Includes Productdesign, Interfacedesign and graphic design)'
};
...
export const VALID_OCCURENCIES = {
...
export const SEMESTER_WEEK_HOURS = {
	MIN: 1,
	MAX: 180
};
